...
class NotificationsPage extends StatelessWidget {
  ...
  static const List<Map<String, String>> _notifications = [
    {'name': 'Nom et Prénom', 'time': 'now', 'desc': 'Lorem ipsum dolor sit amet, consectetur adipiscing'},
    {'name': 'Nom et Prénom', 'time': 'now', 'desc': 'Lorem ipsum dolor sit amet, consectetur adipiscing'},
    {'name': 'Nom et Prénom', 'time': 'now', 'desc': 'Lorem ipsum dolor sit amet, consectetur adipiscing'},
    {'name': 'Nom et Prénom', 'time': 'now', 'desc': 'Lorem ipsum dolor sit amet, consectetur adipiscing'},
  ];
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Search bar
                      Padding(
                        padding: EdgeInsets.fromLTRB(R(18), R(14), R(18), R(20)),
                        child: Container(
                          height: R(46),
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.search, size: R(18), color: Colors.black87),
                              SizedBox(width: R(8)),
                              Expanded(
                                child: Text(
                                  "Que recherchez-vous ?",
                              ...
                              Container(
                                ...
                                child: Icon(Icons.tune, color: Colors.white, size: R(16)),
                              ),
                            ],
                          ),
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...List.generate(_notifications.length, (i) {
                          ...
                          return Column(
                            children: [
                              _notificationTile(n['name']!, n['time']!, n['desc']!, R),
                              if (!isLast)
                                Divider(
                                  height: R(1),
  ...
  Widget _notificationTile(
      String name, String time, String desc, double Function(double) R) {
    return Padding(
